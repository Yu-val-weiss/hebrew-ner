...
if __name__ == '__main__':
    PRED_MORPH = '/Users/yuval/GitHub/hebrew-ner/ncrf_results/transformer/morph/results.txt'
    ...
    yap_morph = ner.read_file_to_sentences_df('/Users/yuval/GitHub/hebrew-ner/ncrf_results/transformer/morph/pred_multi_results.txt')
    origins = ner.read_token_origins_to_df('/Users/yuval/GitHub/hebrew-ner/utils_eval_files/yap_hybrid_trn_pred_multi_dev_tokens.txt')
    ...
    yap_morph = ner.read_file_to_sentences_df('/Users/yuval/GitHub/hebrew-ner/ncrf_results/transformer/morph/gold_multi_results.txt')
